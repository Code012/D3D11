...
HWND global_hwnd = NULL;    //Sets our windows handle to NULL
                         ...
                         bool windowed)
{
    ...
    global_hwnd = CreateWindowEx(       //Create our Extended Window
        NULL,    						//Extended style
    ...
    if (!global_hwnd)    //Make sure our window has been created
    {
    ...
    ShowWindow(global_hwnd, ShowWnd);    	//Shows our window
    UpdateWindow(global_hwnd);    			//Its good to update our window
